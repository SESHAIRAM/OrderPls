...
export const OPEmployeeLogin = () => {
    ...
    function fnGetAuthlogin() {
        ...
        if (socketRef.current) {
            socketRef.current.emit('validateLogin', _getLoginAuth);
        }
    }
    ...
    useEffect(() => {
        ...
        socketRef.current.on('employeeLogin', (responseData) => {
            ...
            if (responseData.isAuth) {
                ...
                dispatchappStore(
                    setrouteinfo({
                        ...getAppRouteData,
                        company: responseData.CompanyName,
                        usertype: responseData.employeeType,
                    })
                )
                navigate(getAppRouteData.lastseen ?? `/${responseData.CompanyName}/${responseData.employeeType}/my-profile`);
            } else {
